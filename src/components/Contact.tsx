...
const MagneticBtn = () => {
  ...
  return (
    <motion.button ref={ref}
      ...
      style={{ x: sx, y: sy }}
      whileTap={{ scale: 0.95 }}
      className="mt-10 px-8 py-3 rounded-full font-bold text-sm tracking-wide text-[#080808] bg-[#ff6b1a] transition-shadow duration-300 hover:shadow-[0_0_32px_rgba(255,107,26,0.45)]"
    >
      Get In Touch
    </motion.button>
  );
...
const Contact = () => (
  <section className="relative bg-[#080808] py-20 px-6 sm:px-12 lg:px-20 overflow-hidden">
    ...
    >
      <p className="text-[10px] text-white/20 tracking-[0.3em] uppercase">Jeevan K G Â© 2025</p>
    </motion.div>
  </section>
);
